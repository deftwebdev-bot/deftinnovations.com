...
class HeroContent(models.Model):
    ...
    video_url = models.URLField(max_length=500, blank=True, null=True, help_text="Optional ambient MP4 background video clip URL")
    hero_image_url = models.URLField(max_length=500, default="https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=2000&q=90")
